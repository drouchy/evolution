defmodule SamplerRunner do
  import ExProf.Macro

  def analyse(problem, settings) do
    profile do
      Evolution.Swarm.solve(problem, settings)
    end
  end

  def run() do
    problem = Evolution.Swarm.Problems.TravelingSalesman
    ...
    {records, _block_result} = analyse(problem, settings)
    total_percent = Enum.reduce(records, 0.0, &(&1.percent + &2))
    IO.inspect total_percent
  end
end
